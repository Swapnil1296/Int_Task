...
console.log(showData)
  return (
    <>
        ...
        <Col lg={6} md={6} sm={8} xs={12}>
          <Row className="border border-bottom-0 border-dark fw-bold ">
            ...
            <Col
              ...
              sm={4}
              xs={4}
              className="border-start border-end border-dark text-center"
            >
              <span>GRADES</span>
            </Col>
            <Col lg={4} md={4} sm={4} xs={4} className="text-center">
          ...
          {showData &&
            showData.map((el, i) => (
              <Row
                className="border border-bottom-0 border-dark text-center fw-bold"
                key={i}
              >
                <Col
                  lg={4}
                ...
                <Col
                  ...
                  sm={4}
                  xs={4}
                  className="border-start border-end border-bottom-0 border-dark text-center"
                >
      ...
      <Row>
        <Col className="text-center  fst-italic border border-dark border-top-1 border-bottom-0 border-start-0 border-end-0">
